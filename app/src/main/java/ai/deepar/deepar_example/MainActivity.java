...
public class MainActivity extends AppCompatActivity implements SurfaceHolder.Callback, AREventListener {
    ...
    private void initializeDeepAR() {
        ...
        deepAR.setLicenseKey("a9afdd2b422fd73818c6ee2a51fa114f1a157dfb9a88ffe50d650dea12c0433fc245ecefbe7d4465");
    ...
    public void screenshotTaken(Bitmap bitmap) {
        ...
        try {
            imageFile = new File(getExternalFilesDir(Environment.DIRECTORY_PICTURES), "image_" + now + ".jpg");
            ...
            Toast.makeText(MainActivity.this, "Filter Saved " + imageFile.getName() + " saved.", Toast.LENGTH_SHORT).show();
            Intent i = new Intent(MainActivity.this, FilterPreview.class);
            startActivity(i);
        } catch (Throwable e) {
            e.printStackTrace();
        }
